...
* 
* Generated at 02/16/2026 20:21:43 UTC. Any changes will be lost.
* 
* Memory    Size                      Efficiency
* State     3408 bytes (RAM)          100 %
* 
...
*    Parameter data_out is Output of size float[100,6].
...
// Working memory
static int8_t _state[3408];

// Memory mapped buffers
#define _K5              ((int8_t *)(_state + 0x00000000))   // s8[3408] (3408 bytes) 
...
int IMAI_dequeue(float *restrict data_out, float *restrict time_out) {    
    __RETURN_ERROR(fixwin_dequeuef32(_K5, data_out, 10, time_out));
    return 0;
}
